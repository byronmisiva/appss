...
<div id="home" class=" seccion fondo-home">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="logo-karaoke">
					<img src="<?php echo base_url()?>imagenes/karaokegalaxya/home/logo_karaoke.png" class="img-responsive"/>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-xs-10 margen-0-md">
							<div class="btn-home-subir-video">
								<img src="<?php echo base_url()?>imagenes/karaokegalaxya/home/boton_subirvideo.png" class="img-responsive"/>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-xs-10 margen-0-md">
							<div class="btn-home-galeria">
								<img src="<?php echo base_url()?>imagenes/karaokegalaxya/home/boton_galeria.png" class="img-responsive"/>
							</div>
						</div>
						<div class="col-xs-1 margen-0"></div>
					</div>
		...
		<div id="comunes-movil" class="hidden-md hidden-sm hidden-lg">
			<div class="col-xs-12">
				<div class="logo-samsung-galaxya "><img src="<?php echo base_url()?>imagenes/karaokegalaxya/home/logo_galaxya.png"
														class="img-responsive"></div>
			</div>

			<div class="col-xs-12">
				<div class="logo-samsung "><img src="<?php echo base_url()?>imagenes/karaokegalaxya/home/logo_samsung.png"
												class="img-responsive"></div>
			</div>
			<div class="col-xs-12">
			...
			<div class="col-md-12 col-sm-12">
				<div class="col-md-12 col-sm-12">
					<div class="logo-karaoke-galeria">
						<img src="<?php echo base_url()?>imagenes/karaokegalaxya/intrucciones/logo_karaoke.png" class="img-responsive"/>
					</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="col-md-12 col-sm-12">
					<div class="logo-karaoke-galeria">
						<img src="<?php echo base_url()?>imagenes/karaokegalaxya/galeria/logo_karaoke.png" class="img-responsive"/>
					</div>
				</div>
				...
				<div class="col-md-6 col-sm-6 col-xs-6 ">
					...
					<div class="col-md-2 col-sm-2 col-xs-2 margen-0">
						<div class="pull-right boton-buscar-video"><p><img src="<?php echo base_url()?>imagenes/karaokegalaxya/galeria/icono_buscar.png"></p></div>
					</div>
					</div>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12">
...
<div id="comunes" class="hidden-xs">
	...
	<div class="col-md-4 col-sm-4 col-xs-5">
		<div class="logo-samsung pull-right "><img src="<?php echo base_url()?>imagenes/karaokegalaxya/home/logo_samsung.png"
												   class="img-responsive"></div>
	</div>
