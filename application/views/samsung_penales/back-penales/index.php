...
<head>
	...
	<link href="<?=base_url('css/samsung_penales/app.css?refresh='.rand(10, 1000))?>" rel="stylesheet">
	<script src="<?=base_url()?>js/samsung_penales/app.js?refresh=<?php echo rand(10, 1000)?>" type="text/javascript" charset="utf-8"></script>
