...
<!--	<div id="content" class="container" style="overflow: hidden;position:absolute;left:0;top:0;height: 700px;width:810px;"></div>-->
	<div id="condiciones">
    ...
    <script src="<?=base_url()?>js/samsung_ruleta/app.js?refresh=<?php echo rand(10, 1000)?>" type="text/javascript" charset="utf-8"></script>
