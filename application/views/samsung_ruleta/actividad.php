...
<div class="actividad-1">
    ...
    <div class="mensajesalida  colorgris ocultar salidasinganar">
        <div class="logo"></div>
        <div class="telefono posactividad-2"></div>
    ...
    <div id="pierde" class="ocultar">
        ...
        <div id="colorgris" class="tpierde colorgris"> No lograste ganarte un <strong>accesorio</strong>. Si quieres dar una vuelta más a la ruleta, debes
