...
<head>
	...
	<link href="<?=base_url('css/samsung_4g/app.css?refresh='.rand(10, 1000))?>" rel="stylesheet">
	<link href="<?=base_url('css/samsung_4g/animate.min.css?refresh='.rand(10, 1000))?>" rel="stylesheet">
	<script src="<?=base_url()?>js/samsung_4g/app.js?refresh=<?php echo rand(10, 1000)?>" type="text/javascript" charset="utf-8"></script>
...
<body>
	<div id="fb-root"></div>
	<div id="content" class="container" style="overflow: hidden;position:absolute;left:0;top:0;height: 760px;width:810px;"></div>
	<div id="condiciones" >
