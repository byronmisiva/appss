...
<div class="contenedor-principal">
	<form id="formaPieza" name="formaPieza" method="post" enctype="multipart/form-data" action="<?php echo base_url().'samsung_galaxy_a/imagenPieza'?>" >
		<div class="imagen-mascara">
				<img src="<?php echo base_url()?>imagenes/galaxy-a/04/BT_2.png" class="subir-imagen"/>
		</div>
