			...
			<article>
					...
					<div class="registro registro-label" >
						<form id="register" name="register" method="post" role="form" class="form-horizontal formulario" >
							...
							<div class="form-group " >			
								<div class="form-control inputTexto espaciador-registro" >
									<input type="text" id="telefono" name="telefono"  value="" maxlength="10" />
								</div>
							</div>
							...
							<div class="form-group " >			
								<div class="form-control inputTexto" style="margin-top: 8px;">
									<input type="date" name="fnacimiento" id="fnacimiento" value="" >									
								</div>
							</div>
...
window.fbAsyncInit = function() {
  ...
  (function(d, s, id){
	...
	validator.registerCallback('fnacimiento', function(value) {		
		...
		if(parseInt(res[0])<1984 && parseInt(res[0])>1996){
			$(".registro").hide();
			$(".registro").html("");
