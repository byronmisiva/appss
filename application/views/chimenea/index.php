...
<head>
    ...
    <link href="<?php echo base_url() ?>css/chimenea/app.css" type="text/css" rel="stylesheet"/>
...
<div class="container secciones registro hidden ">
    <div class="row">
    ...
    <div class="vertical-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 text-center padding-20 ">
                <img src="<?php echo base_url() ?>imagenes/chimenea/home/logo_christmastour_home.png"/>
            </div>
            <div class="clearfix"></div>
...
<div class="container secciones resultados hidden">
    ...
    <div class="row margin-20">
        <div class="col-lg-6 col-sm-6 col-xs-6 ">
            <div class="btn text-center js--btn-jugar">Volver a Jugar</div>
        </div>
        <div class="col-lg-6 col-sm-6 col-xs-6">
            <div class="btn text-center js--btn-ranking">Ranking</div>
        </div>
        <div class="clearfix"></div>
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="text-center">Compartir con amigos LogoFace LogoTwiter</div>
        </div>
    </div>
</div>
