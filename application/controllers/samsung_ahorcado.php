<?php 
class Samsung_ahorcado extends Facebook_Controller{ 
	
	public $data;	
	public $config_file = 'fb_ahorcado';	
	public $_rules = array(
	...
	public function __construct(){
		...
		$this->data['condiciones'] = "
				<a href='".base_url()."archivos/samsung_todocurvo/TERMINOS-Y-CONDICIONES-CONCURSO-TODO-LO-CURVO-ES-MEJOR.pdf' 
	...
	function ingresoActividad($sw="0"){
		$data['elementos']=array("Teclado tracional","Roca cuadrada","Pedazo de salmón","Pedazo de Pizza","Tierra Plana",
					 			 "Mujer","Una tira de lana");
		$data['mejorados']=array("Teclado curvo","Rueda de Piedra","Sushi roll","Pizza completa","Tierra redonda",
				"Mujer embarazada","Estambre");
