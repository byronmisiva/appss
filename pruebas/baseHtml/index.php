            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-12 col-sm-12">
                    <div class="logo-karaoke-galeria">
                        <img src="imagenes/karaokegalaxya/intrucciones/logo_karaoke.png" class="img-responsive"/>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10  ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-10 margen-0-md">
                                <div class="btn-home-home ">
                                    <img src="imagenes/karaokegalaxya/intrucciones/boton_home.png"
                                         class="img-responsive "/>
                                </div>
                            </div>
                            <div class="col-xs-1 margen-0"></div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 margen-0-md">
                        <div class="row">
                            ...
                            <div class="col-xs-10 margen-0-md">
                                <div class="btn-home-galeria">
                                    <img src="imagenes/karaokegalaxya/intrucciones/boton_galeria.png"
                                         class="img-responsive"/>
                                </div>
                            </div>
                            <div class="col-xs-1 margen-0"></div>
...
<div id="comunes" class="hidden-xs">
    ...
    <div class="col-md-4 col-sm-4 col-xs-5">
        <div class="logo-samsung pull-right "><img src="imagenes/karaokegalaxya/home/logo_samsung.png"
                                                   class="img-responsive"></div>
    </div>
